...
export const PROJECTS = [
  {
    ...
    bullets: [
      'Deployed 5 interdependent FastAPI microservices — failures genuinely propagate through the dependency chain via real synchronous calls.',
      'Built chaos engine with 5 fault types (latency, errors, partition, resource exhaustion, kill) and 3 automated scenarios.',
      'Integrated Claude API to auto-generate structured SRE post-mortems — severity classification, root cause analysis, action items.',
      'Observable via Prometheus, Grafana dashboards, and live D3.js topology graph with real-time WebSocket updates.',
    ],
