...
export const EDUCATION = [
  { school:'Arizona State University', degree:'M.S. Information Technology Project Management', meta:'Aug 2024 – May 2026 · Tempe, AZ', gpa:'3.4 / 4.0', star:false, note:'Completed while working two concurrent roles — data engineering at NASA L\'SPACE and AI product management at ASU.' },
  { school:'Sarvajanik College of Engineering & Technology (Gujarat Technological University)', degree:'B.E. Computer Engineering', meta:'Jun 2021 – Jun 2024 · Surat, India', gpa:'3.7 / 4.0', star:false, note:'Founded Kaleidoscope — a student tech community I built from zero into a running program of workshops, events, and hackathons.' },
]
