...
export const EXPERIENCE = [
  { icon:'🚀', role:'Software Engineer', company:"NASA L'SPACE Program", location:'Tempe, AZ', time:'Apr 2025 – Present', type:'Full-time', summary:'Engineering mission-critical data infrastructure across 100,000+ records.', bullets:['Built ETL pipelines with **95% anomaly detection accuracy** and zero integrity failures.','Replaced manual reporting with **live dashboards for 3 research teams**.','Introduced **pytest coverage to 80%+** and GitHub Actions CI.'], stack:['Python','SQL','ETL','PostgreSQL','pytest','GitHub Actions'] },
