...
const CAT_COLORS = {
  ...
  'AI / LLM Systems':  { bg:'rgba(64,202,255,.08)',  bd:'rgba(64,202,255,.3)',   lb:'rgba(64,202,255,.9)'   },
  'Data Engineering':  { bg:'rgba(255,200,80,.07)',  bd:'rgba(255,200,80,.28)',  lb:'rgba(255,200,80,.85)'  },
  'Backend & Infra':   { bg:'rgba(255,140,105,.08)', bd:'rgba(255,140,105,.3)',  lb:'rgba(255,140,105,.9)'  },
  'Product & Program': { bg:'rgba(200,100,220,.08)', bd:'rgba(200,100,220,.3)',  lb:'rgba(200,100,220,.9)'  },
  'Familiar':          { bg:'rgba(255,255,255,.03)', bd:'rgba(255,255,255,.12)', lb:'rgba(255,255,255,.5)'  },
}
